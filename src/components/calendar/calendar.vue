  ...
  <div class="calendar">
    <div class="toolbar">
      <div class="year-picker">
        <div class="icon icon-prev" :class="reachMinYear ? 'disabled' : '' " @click="prevYear()"></div>
        <div class="year-value">{{currentYear}}</div>
        <div class="icon icon-next" :class="reachMaxYear ? 'disabled' : '' " @click="nextYear()"></div>
      </div>
      <div class="month-picker">
        <div class="icon icon-prev" :class="reachMin ? 'disabled' : '' " @click="prevMonth()"></div>
        <div class="month-value">{{currentMonth+1}}</div>
        <div class="icon icon-next" :class="reachMax ? 'disabled' : '' " @click="nextMonth()"></div>
      </div>
    </div>
    <div class="weekdays">
    ...
    <div class="months" :class="transition ? 'transition' : '' " v-swipe:start="_start" v-swipe:move="_move" v-swipe:end="_end">
