<template>
  <div class="slide-wrap" :class="transition && !touching ? 'transition' : '' " v-swipe:start="_swipeStart" v-swipe:move="_swipeMove" v-swipe:end="_swipeEnd">
    ...
    <div class="bullets">
      <div class="bullet" :class="activeIndex === i || (activeIndex === amount - 1 && i === 1) || (activeIndex === 0 && i === amount - 2) ? 'active' : '' " v-for="i in bullets"></div>
    </div>
  </div>
</template>
